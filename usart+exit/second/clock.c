...
/*CONFIG_CLK_1000_200_166_133
 ...
 数据手册可知： 
 APLL: fout = 1000时，P=3,m=125,s=1
 MPLL: fout = 166 时，  (看最大的，然后用分频分出来！)
*/
void clock_init(void)
{
    ...
    // 设置锁定时间，时钟从Fin提成到Fout时需要一定的时间
     rREG_APLL_LOCK = 0x00000FFF;
	 rREG_MPLL_LOCK = 0x00000FFF;
    //设置分频
    rREG_CLK_DIV0 = 0x14131440;
    //设置PLL
	rREG_APLL_CON0 |= APLL_VAL | (1<<31);
	rREG_MPLL_CON |= MPLL_VAL| (1<<31);
	//设置各种时钟开关，使用PLL
